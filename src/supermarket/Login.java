...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtUid.setFont(new java.awt.Font("Century Gothic", 1, 18)); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtUid, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
...
ResultSet Rs = null;
    ...
    private void btnloginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnloginMouseClicked
      ...
      {
        String Query = "select * from User1.SELLERTBL where SELNAME='"+txtUid.getText()+"' and SELPASS='"+password.getText()+"'";
       try{
    ...
    if(Rs.next()){
       ...
       }catch(SQLException ex)
       {
           ...
           String Query = "select * from User1.ADMINTBL where ADMINNAME='"+txtUid.getText()+"' and ADMINPASS='"+password.getText()+"'";
       try{
           Con = DriverManager.getConnection("jdbc:derby://localhost:1527/SuperMarketdb","User1","1234");
    St = Con.createStatement();
    Rs = St.executeQuery(Query);
